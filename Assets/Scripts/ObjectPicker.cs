...
public class ObjectPicker : MonoBehaviour
{
    ...
    void StartPickup()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            pickableObject = null;
            pickedRbDragLinearOriginal = pickedObject.rb.linearDamping;
            pickedObject.rb.linearDamping = pickedRbDragLinear;
            pickedRbDragAngularOriginal = pickedObject.rb.angularDamping;
            pickedObject.rb.angularDamping = pickedRbDragAngular;
            state = PICKSTATE.NOTVISIBLE;
            line.enabled = true;
        }
    }
